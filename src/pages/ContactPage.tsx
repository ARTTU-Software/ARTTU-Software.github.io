...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="pt-28 pb-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <ScrollReveal direction="left" duration={650}>
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-warm-250 shadow-sm flex flex-col justify-between space-y-4 h-full card-hover-glow">
            ...
            <div className="pt-3 border-t border-warm-150 text-xs font-mono text-warm-500">
              ...
              <button
                ...
                className={`py-2.5 px-4 rounded-xl border transition flex items-center gap-1.5 font-mono text-xs font-semibold shadow-xs ${
                  copiedEmail
                    ...
                    : 'border-warm-300 bg-white hover:bg-warm-100 text-warm-800'
                }`}
      ...
      <ScrollReveal direction="up" delay={120} duration={650}>
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-warm-250 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <a
              ...
              className="p-4 rounded-2xl bg-warm-50 border border-warm-200 hover:border-brand-red hover:bg-white text-warm-800 hover:text-brand-red transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-1 flex items-center gap-3.5 group"
              aria-label="Instagram"
            >
              <div className="p-2.5 rounded-xl bg-white border border-warm-200 group-hover:border-brand-red/30 text-warm-700 group-hover:text-brand-red transition shadow-xs shrink-0">
