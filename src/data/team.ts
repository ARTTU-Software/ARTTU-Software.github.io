...
export const teamGenerations: TeamGeneration[] = [
  ...
  },
  {
    ...
    yearSpan: "2022 - 2023",
    tagline: "First Romanian Electric Vehicle at Formula Student Alpe Adria (Novi Marof)",
    ...
    description: "In August 2022, we made history by becoming the first Romanian Formula Student team to enter an all-electric single-seater prototype at an official international event (FS Alpe Adria in Novi Marof, Croatia). Overcoming tremendous high-voltage engineering challenges, the team finished 25th out of 31 electric teams in statics.",
    highlights: [
